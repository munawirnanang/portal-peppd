...
<div class="container" style="width: 100%; margin-top: -2%;">
    <br>
    <h6 class="menu-title" id="publication-content" style="text-align: left; position: absolute;"><b><i class="tiny material-icons">bookmark</i> PETUNJUK</b></h6>
    ...
    <div class="col s12 m6 l4">
        <div class="card guide-list-content-card hoverable" style="border-radius: 10px 10px 10px 10px;">
            <div class="card-image guide-list-content-card-image" style="background-color: #1F3984;">
                ...
                <div class="overlay">
                    <a href="#" class="icon" title="Download {{ $list->name }}">
    ...
    <!-- <div class="col s12 m6 l4">
        <div class="card guide-list-content-card hoverable" style="border-radius: 10px 10px 10px 10px;">
            ...
            <div class="card-content guide-list-content-card-content" style="text-align: center;">
                <p>Pedoman Sistem PPD Pengguna Daerah (provinsi)</p>
            </div>
        </div>
    </div> -->
