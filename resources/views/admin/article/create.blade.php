            ...
            <form action="{{ url('article') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="create_title" name="title" placeholder="Enter Title" value="{{ old('title') }}" required>
                                @error('title')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file @error('title_picture') is-invalid @enderror" id="create_title_picture" name="title_picture" value="{{ old('title_picture') }}">
                                @error('title_picture')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea id="create_article_summernote" name="text">{{ old('text') }}</textarea>
                    </div>
                </div>
